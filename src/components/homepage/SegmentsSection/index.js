...
export default function SegmentsSection() {
  ...
  return (
    <div className=' overflow-x-clip relative w-full '>
      ...
      <div
        ref={mainRef}
        className='flex absolute  top-0 justify-center items-center md:h-[60vh] bg-white sm:bg-transparent w-screen h-60'
      >
        <div
          ref={circleRef}
          className='absolute -top-6  will-change-transform bg-white rounded-full  w-[100vh] h-screen mx-auto'
        ></div>
      </div>
