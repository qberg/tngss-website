...
const MobileCMSection = ({ isSticky = true }) => {
  return (
    <motion.div
      style={{
        background:
      ...
      } overflow-hidden w-full h-svh z-10 p-2`}
    >
      <section
      ...
      >
        ...
        {/* Image Section */}
        <div className='w-full md:w-1/2 h-1/2 md:h-full flex items-center justify-center mt-20'>
          <img
            alt='Chief Minister'
            src={CM}
...
export default MobileCMSection
