    ...
    <GradientBdrCard className='p-1 rounded-md font-urbanist'>
      ...
      >
        <div className='backdrop-blur-sm rounded-xl p-4'>
          ...
          {introData && (
            <>
              ...
              {introDescription.length > 0 && (
                <div className='text-gray-800 mb-3 text-lg md:text-xl text-left'>
          ...
          {missionData && (
            <div className='flex flex-col md:flex-row md:items-center justify-center gap-8 md:mt-12 items-start text-left'>
