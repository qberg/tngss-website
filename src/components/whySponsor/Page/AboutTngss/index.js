  ...
  return (
    <section className='relative overflow-hidden'>
      <div className='w-full h-full px-1 pb-1'>
        <div className='w-full h-full flex flex-col items-start gap-3 md:gap-5 2xl:gap-7 justify-start p-8 md:px-16 2xl:px-28 md:py-12 2xl:py-28 bg-black overflow-hidden'>
          {/*header*/}
          <div className='w-full text-white text-6xl md:text-7xl mb-8 2xl:mb-20 font-medium font-urbanist gradient-text-black md:leading-relaxed text-left'>
            <h3 className='uppercase'>{aboutTngss?.title}</h3>
          </div>

          {/*content+image*/}
          <div
            className={
              'flex flex-col w-full md:gap-16 2xl:gap-20 md:flex-row-reverse'
            }
          >
            {/*content*/}
              ...
              >
                ...
                >
                  <img
                    ...
                    alt={
                      aboutTngss?.image_block.image.alt || 'About TNGSS image'
                    }
