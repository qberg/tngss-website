...
const EventHighlights = () => {
  ...
  return (
    <GradientBdrCard
      className='p-0.5 w-full h-fit md:w-11/12 rounded-3xl md:mx-auto my-12'
      style={{}}
    >
      <div
      ...
      >
        <div className='w-full text-white text-5xl md:text-7xl mb-8 2xl:mb-20 font-medium font-urbanist gradient-text-black md:leading-relaxed text-center md:text-left'>
          <h3 className='uppercase'>{eventHighlights?.title}</h3>
        </div>
        <div
          className='grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 2xl:grid-cols-7 gap-8 auto-rows-fr auto-cols-fr'
          style={{
