...
const SponsBenefits = () => {
    ...
    return (
        <div className='w-full h-full px-8 md:px-16 2xl:px-28 py-4 md:py-12 2xl:py-28'>
            ...
            <div>
                <div className='w-full text-white text-4xl md:text-6xl my-8 2xl:my-20 font-medium font-urbanist gradient-text-black md:leading-relaxed text-center justify-center'>
                    <h3 className='uppercase'>
