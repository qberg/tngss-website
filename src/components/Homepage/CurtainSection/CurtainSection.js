    ...
    <div className='relative w-full'>
      <div className=' relative h-fit  w-full z-10 '>
        <div
          ...
          className='absolute opacity-50 custom-gradient will-change-transform custom-size custom-blur custom-translate rounded-full'
        ></div>

        <div ref={dummyref} className='w-full text-center'>
          <p
            ref={headingRef}
            className='text-white will-change-transform text-6xl md:text-9xl opacity-80 mix-blend-lighten gradient-text-attend mt-10'
          >
            Why Attend
          </p>
        </div>
