...
//   <div className=' relative herotxt z-20 md:mt-20 will-change-transform sm:mt-12'>
...
//     <div className=' absolute bottom-20 md:bottom-6 text-white text-2xl flex justify-center align-end   py-3 z-20  md:mt-6 lg:mt-6 '>
...
export default function HeroSection({ className = "" }) {
  ...
  return (
    <>
      {/* SCOPED CSS - Only affects #hero-section */}
...
"
          ...
          >
            ...
            <div className="logo-3d-wrapper hero-animate-floatUpBounce mt-8">
              <img
                alt="StartupTN Logo"
                src={herobannerlogo || "/placeholder.svg"}
                style={{ maxWidth: "50%" }}
            ...
            >
              ...
              <div className="w-full">
                <img
                  src={startupwhite || "/placeholder.svg"}
                  alt="Decorative Shape"
                  className=""
                  style={{ maxWidth: "60%" }}
                />
        ...
        <div className="hero-animate-fadeIn-delay-3 text-white text-2xl flex justify-center align-end py-3 z-20 flex flex-col mb-12 ">
          <CTAButton src="https://event.startuptn.in/" className="rounded-2xl hover:scale-105">
            <div className="w-70 h-10 px-6 py-7 flex items-center justify-center">
              <img className="px-2" src={vector || "/placeholder.svg"} /> Book Your Pass
            </div>
          </CTAButton>
