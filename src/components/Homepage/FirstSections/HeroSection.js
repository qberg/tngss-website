...
export default function HeroSection({ className = '' }) {
  ...
  const [data, setData] = useState({
    id: 2,
    documentId: 'o6cb46sbmd2829k6a85h6g3r',
    banner: 'October 9th & 10th 2025, Codissia Trade Fair Complex, Coimbatore',
    phone1: '4422256789',
    phone2: '55343',
    email: 'events@startuptn.in',
    createdAt: '2025-07-21T16:44:00.996Z',
    updatedAt: '2025-07-21T16:44:00.996Z',
    publishedAt: '2025-07-21T16:44:01.005Z',
  })
  ...
  return (
    ...
    >
      ...
      <div className=' relative herotxt z-20 md:mt-20 will-change-transform '>
        <div
          className=' animate-floatUpBounce  relative  h-fit h-[50vh] will-change-transform flex justify-center items-center gap-4 text-center  px-4 md:px-10 '
          ...
          >
            ...
            <div className='flex flex-col items-start md:items-start text-left w-full'>
              <p className='text-white font-bold text-left leading-tight'>
                <span className='font-montserrat font-bold block text-4xl md:text-7xl'>
                  GLOBAL
                </span>
                <span className='font-montserrat  block text-4xl md:text-7xl'>
                  STARTUP
                </span>
                <span className='font-montserrat  block text-2xl md:text-5xl'>
                  SUMMIT - 2025
                </span>
              </p>
              <p
                className='text-white text-lg md:text-4xl tracking-[0.2rem] mt-2 animate-floatUpBounce'
      ...
      <p className=' text-center text-3xl md:text-5xl mb-5 md:mb-7 mt-14 md:mt-12  z-30'>
        <img className='w-6 md:w-9 inline mb-1  mr-1 text-white' src={pin} />
        Codissia Trade Fair Complex, Coimbatore
      </p>
      <p className='text-center text-2xl md:text-3xl mb-14 md:mb-4 z-30'>
      ...
      <div className=' absolute bottom-20 md:bottom-6 text-white text-2xl flex justify-center align-end   py-3 z-20   '>
        ...
        >
          <div className='w-70 h-10 px-6 py-7 flex items-center justify-center '>
            <img className='px-2' src={vector} /> Book Your Pass
          </div>
        </CTAButton>
      </div>
    </section>
