      ...
      >
        <div className='w-full h-full flex flex-col items-start gap-3 md:gap-5 2xl:gap-7 justify-start px-4 md:px-16 2xl:px-28 py-4 md:py-12 2xl:py-28 overflow-hidden bg-black'>
          ...
          <div className='mb-4 md:mb-8 2xl:mb-20'>
            <h3 className='text-2xl md:text-5xl 2xl:text-6xl uppercase text-white group-hover:text-[#18BFDB] transition-colors font-medium md:mb-2'>
          ...
          >
            ...
            <div className='w-full md:w-1/2 mb-6 md:mb-2'>
              {/*mobile image */}
              <div className='md:hidden flex flex-col items-center justify-center relative flex-1 mb-6'>
                <div
            ...
            {/*image*/}
            <div className='hidden md:w-1/2 md:flex flex-col items-center justify-center relative flex-1'>
              <div
                className='p-0.5 w-full h-fit overflow-hidden'
                style={{
                  maxHeight: '400px',
