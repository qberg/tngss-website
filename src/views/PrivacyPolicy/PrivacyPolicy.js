  ...
  return (
    <div className='font-urbanist'>
      <Helmet className='font-urbanist'>
        ...
        <meta
          name='description'
          content='Privacy policy for the TNGSS mobile app created by Tamil Nadu Startup and Innovation Mission (TANSIM) - StartupTN. Learn how your data is collected, used, and protected.'
        />
      </Helmet>
        ...
        <div className='relative w-full'>
          <div className=' relative h-fit  w-full '>
            ...
            <p className='mb-4 text-xl '>
              This privacy policy applies to the TNGSS app (hereby referred to
              as "Application") for mobile devices that was created by Tamil
              Nadu Startup and Innovation Mission (TANSIM) - StartupTN (hereby
            ...
            <ul className='list-disc list-inside mb-4 space-y-1'>
              ...
              <li>
                Pages visited, time and date of visit, time spent on those pages
              </li>
            ...
            <p className='mb-4 text-xl '>
              The Service Provider may use this information to contact you with
              important updates or marketing promotions.
            </p>
            <p className='mb-4 text-xl '>
              Some personally identifiable information may be requested for a
              better experience. This data will be retained and used as outlined
              in this policy.
            </p>
            ...
            <p className='mb-4 text-xl '>
              Only aggregated, anonymized data is sent to third parties for app
              improvement.
            </p>
            ...
            <ul className='list-disc list-inside mb-4 space-y-1'>
              ...
              <li>
                To protect rights or safety, investigate fraud, or respond to
                government requests
              </li>
              <li>
                With service providers working on behalf of the Service Provider
            ...
            <p className='mb-4 text-xl '>
              User data is retained while you use the app and for a reasonable
              time after. To request data deletion, contact:
              <a
                href={`mailto:${email}`}
              ...
              <button
                ...
                className='ml-2 px-2 py-1 text-sm bg-cyan-500 rounded hover:bg-cyan-600'
              >
                Copy Email
              </button>
            </p>
            ...
            <p className='mb-4 text-xl '>
              Parents are encouraged to monitor and guide children's app usage.
            </p>
            <p className='mb-4 text-xl '>
            ...
            <p className='mb-4 text-xl '>
              You must be at least 16 years old to consent to data processing
              (or have a guardian’s consent).
            </p>
            ...
            <p className='mb-4 text-xl '>
              This Privacy Policy may be updated periodically. You should check
              this page for changes, as continued use implies acceptance.
            </p>
